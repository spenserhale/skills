---
name: TabPanel
description: "TabPanel is a React component to render an ARIA-compliant TabPanel."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/tab-panel
docs: https://developer.wordpress.org/block-editor/reference-guides/components/tab-panel/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-tabpanel--docs
---
