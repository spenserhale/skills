...
description: "ComboboxControl is an enhanced version of a [SelectControl](/packages/components/src/select-control/README.md), with the"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/combobox-control
docs: https://developer.wordpress.org/block-editor/reference-guides/components/combobox-control/
