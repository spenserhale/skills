---
name: Draggable
description: "Draggable is a Component that provides a way to set up a cross-browser (including IE) customizable drag image and the tr"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/draggable
docs: https://developer.wordpress.org/block-editor/reference-guides/components/draggable/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-draggable--docs
---
