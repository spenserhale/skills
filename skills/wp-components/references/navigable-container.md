---
name: NavigableContainer
description: "NavigableContainer is a React component to render a container navigable using the keyboard. Only things that are focusab"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/navigable-container
docs: https://developer.wordpress.org/block-editor/reference-guides/components/navigable-container/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-navigablecontainer--docs
---
