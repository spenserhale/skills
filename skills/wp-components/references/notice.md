---
name: Notice
description: "Use Notices to communicate prominent messages to the user."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/notice
docs: https://developer.wordpress.org/block-editor/reference-guides/components/notice/
