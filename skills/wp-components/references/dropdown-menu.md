---
name: DropdownMenu
description: "The DropdownMenu displays a list of actions (each contained in a MenuItem, MenuItemsChoice, or MenuGroup) in a compact w"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/dropdown-menu
docs: https://developer.wordpress.org/block-editor/reference-guides/components/dropdown-menu/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-dropdownmenu--docs
---
