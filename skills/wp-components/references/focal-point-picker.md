...
description: "Focal Point Picker is a component which creates a UI for identifying the most important visual point of an image. This c"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/focal-point-picker
docs: https://developer.wordpress.org/block-editor/reference-guides/components/focal-point-picker/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-focalpointpicker--docs
---
