...
description: "MenuItemsChoice functions similarly to a set of MenuItems, but allows the user to select one option from a set of multip"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/menu-items-choice
docs: https://developer.wordpress.org/block-editor/reference-guides/components/menu-items-choice/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-menuitemschoice--docs
---
