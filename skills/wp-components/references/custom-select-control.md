...
description: "CustomSelectControl allows users to select an item from a single-option menu just like [SelectControl](/packages/compone"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/custom-select-control
docs: https://developer.wordpress.org/block-editor/reference-guides/components/custom-select-control/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-customselectcontrol--docs
---
