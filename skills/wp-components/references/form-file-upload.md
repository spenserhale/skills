---
name: FormFileUpload
description: "FormFileUpload allows users to select files from their local device."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/form-file-upload
docs: https://developer.wordpress.org/block-editor/reference-guides/components/form-file-upload/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-formfileupload--docs
---
