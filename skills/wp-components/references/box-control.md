---
name: BoxControl
description: "A control that lets users set values for top, right, bottom, and left. Can be"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/box-control
docs: https://developer.wordpress.org/block-editor/reference-guides/components/box-control/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-boxcontrol--docs
---
