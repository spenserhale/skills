---
name: Tabs
description: "Tabs is a collection of React components that combine to render"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/tabs
docs: https://developer.wordpress.org/block-editor/reference-guides/components/tabs/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-tabs--docs
---
