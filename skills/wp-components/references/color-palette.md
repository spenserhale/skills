---
name: ColorPalette
description: "ColorPalette allows the user to pick a color from a list of pre-defined color entries."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/color-palette
docs: https://developer.wordpress.org/block-editor/reference-guides/components/color-palette/
