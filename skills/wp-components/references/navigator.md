---
name: Navigator
description: "Navigator is a collection components that allow rendering nested views/panels/menus (via the Navigator.Screen component)"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/navigator
docs: https://developer.wordpress.org/block-editor/reference-guides/components/navigator/
