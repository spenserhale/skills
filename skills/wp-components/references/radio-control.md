---
name: RadioControl
description: "Use radio buttons when you want users to select one option from a set, and you want to show them all the available optio"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/radio-control
docs: https://developer.wordpress.org/block-editor/reference-guides/components/radio-control/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-radiocontrol--docs
---
