...
description: "This component is deprecated. Please use the useCopyToClipboard hook from the @wordpress/compose package instead."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/clipboard-button
docs: https://developer.wordpress.org/block-editor/reference-guides/components/clipboard-button/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-clipboardbutton--docs
---
