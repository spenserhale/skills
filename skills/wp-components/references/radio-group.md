---
name: RadioGroup
description: "This component is deprecated. Consider using RadioControl or ToggleGroupControl instead."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/radio-group
docs: https://developer.wordpress.org/block-editor/reference-guides/components/radio-group/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-radiogroup--docs
---
