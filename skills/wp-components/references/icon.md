---
name: Icon
description: "Renders a raw icon without any initial styling or wrappers."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/icon
docs: https://developer.wordpress.org/block-editor/reference-guides/components/icon/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-icon--docs
---
