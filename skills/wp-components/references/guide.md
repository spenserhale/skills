---
name: Guide
description: "Guide is a React component that renders a _user guide_ in a modal. The guide consists of several pages which the user ca"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/guide
docs: https://developer.wordpress.org/block-editor/reference-guides/components/guide/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-guide--docs
---
