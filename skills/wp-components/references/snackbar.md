---
name: Snackbar
description: "Use Snackbars to communicate low priority, non-interruptive messages to the user."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/snackbar
docs: https://developer.wordpress.org/block-editor/reference-guides/components/snackbar/
