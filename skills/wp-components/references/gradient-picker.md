---
name: GradientPicker
description: "GradientPicker is a React component that renders a color gradient picker to"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/gradient-picker
docs: https://developer.wordpress.org/block-editor/reference-guides/components/gradient-picker/
