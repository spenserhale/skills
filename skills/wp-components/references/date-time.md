---
name: DateTime
description: "DateTimePicker is a React component that renders a calendar and clock for date and time selection. The calendar and cloc"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/date-time
docs: https://developer.wordpress.org/block-editor/reference-guides/components/date-time/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-datetime--docs
---
