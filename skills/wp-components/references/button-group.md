---
name: ButtonGroup
description: "ButtonGroup can be used to group any related buttons together. To emphasize related buttons, a group should share a comm"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/button-group
docs: https://developer.wordpress.org/block-editor/reference-guides/components/button-group/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-buttongroup--docs
---
