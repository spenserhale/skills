---
name: CustomSelectControlV2
description: "Used to render a customizable select control component."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/custom-select-control-v2
docs: https://developer.wordpress.org/block-editor/reference-guides/components/custom-select-control-v2/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-customselectcontrolv2--docs
---
