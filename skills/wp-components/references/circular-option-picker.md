...
description: "This component is not exported, and therefore can only be used internally to the @wordpress/components package."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/circular-option-picker
docs: https://developer.wordpress.org/block-editor/reference-guides/components/circular-option-picker/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-circularoptionpicker--docs
---
