---
name: Popover
description: "Popover renders its content in a floating modal. If no explicit anchor is passed via props, it anchors to its parent ele"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/popover
docs: https://developer.wordpress.org/block-editor/reference-guides/components/popover/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-popover--docs
---
