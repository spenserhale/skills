---
name: RangeControl
description: "RangeControls are used to make selections from a range of incremental values."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/range-control
docs: https://developer.wordpress.org/block-editor/reference-guides/components/range-control/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-rangecontrol--docs
---
