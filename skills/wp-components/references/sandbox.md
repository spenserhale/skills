---
name: Sandbox
description: "This component provides an isolated environment for arbitrary HTML via iframes."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/sandbox
docs: https://developer.wordpress.org/block-editor/reference-guides/components/sandbox/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-sandbox--docs
---
