...
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/text
docs: https://developer.wordpress.org/block-editor/reference-guides/components/text/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-text--docs
---
