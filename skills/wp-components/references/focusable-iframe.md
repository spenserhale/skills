---
name: FocusableIframe
description: "<FocusableIframe /> is a component rendering an iframe element enhanced to support focus events. By default, it is not p"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/focusable-iframe
docs: https://developer.wordpress.org/block-editor/reference-guides/components/focusable-iframe/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-focusableiframe--docs
---
