---
name: Button
description: "Lets users take actions and make choices with a single click or tap."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/button
docs: https://developer.wordpress.org/block-editor/reference-guides/components/button/
