...
description: "A wrapper component that maintains its aspect ratio when resized."
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/responsive-wrapper
docs: https://developer.wordpress.org/block-editor/reference-guides/components/responsive-wrapper/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-responsivewrapper--docs
---
