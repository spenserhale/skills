---
name: Tooltip
description: "Tooltip is a React component to render floating help text relative to a node when it receives focus or it is hovered upo"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/tooltip
docs: https://developer.wordpress.org/block-editor/reference-guides/components/tooltip/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-tooltip--docs
---
