...
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/text-control
docs: https://developer.wordpress.org/block-editor/reference-guides/components/text-control/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-textcontrol--docs
---
