---
name: Menu
description: "Menu is a collection of React components that combine to render"
source: https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/menu
docs: https://developer.wordpress.org/block-editor/reference-guides/components/menu/
storybook: https://wordpress.github.io/gutenberg/?path=/docs/components-menu--docs
---
